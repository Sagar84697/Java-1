...
class TicTacToe1
{
	...
	static void insert(int pos,char board[][], char sym)
	{
		...
		if(sym=='X')
		{
			SingleplayerTT.allP1Pos.add(pos);
		}
		else if(sym=='O')
		{
			SingleplayerTT.allP2Pos.add(pos);
		}
	}
...
public class SingleplayerTT {
	...
	public static void main(String[] args) 
	{
		...
		while(true)
		{
			...
			TicTacToe1.insert(player1Pos, board,'X');
			TicTacToe1.showBoard(board);
			TicTacToe1.checkWinner(allP1Pos, allP2Pos);
			...
			TicTacToe1.insert(player2Pos, board,'O');
			TicTacToe1.showBoard(board);
			TicTacToe1.checkWinner(allP1Pos, allP2Pos);
